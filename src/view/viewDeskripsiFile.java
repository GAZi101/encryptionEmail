 ...
 * @author rockiericker
 */
public class viewDeskripsiFile extends javax.swing.JDialog {
...
private final serverGmail server = new serverGmail();
     ...
     */
    public viewDeskripsiFile(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        aturFrame(0.85,true);
...
fileLabel.setText(namaFile);
    ...
    private void deskripButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deskripButtonActionPerformed
        ...
        outputByte = enkripsi.deskripFile(file, passwordField.getText(),persenProgessbar);
        if(outputByte!=null){
        ...
        if(userSelection == JFileChooser.APPROVE_OPTION){
                String extension = "";
                String namaFile = enkripsi.getNamaFile();
            ...
            try{
                ...
                outputStream.close();
                JOptionPane.showMessageDialog(null,"File Berhasil Di Deskripsi","Informasi",JOptionPane.INFORMATION_MESSAGE);       
            }catch(Exception e){
...
dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewDeskripsiFile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                viewDeskripsiFile dialog = new viewDeskripsiFile(new javax.swing.JFrame(), true);
