 ...
 * @author Resa S.A
 */
public class tulisEmail extends javax.swing.JDialog {
...
private final serverKirimEmail serverkirimEmail = new serverKirimEmail();
     ...
     */
    public tulisEmail(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tulisEmail.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                tulisEmail dialog = new tulisEmail(new javax.swing.JFrame(), true);
