 ...
 * @author Resa S.A
 */
public class viewBalasEmail extends javax.swing.JDialog {
...
private final Enkrip enkrip =new Enkrip();   
     ...
     */
    public viewBalasEmail(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
 ...
 private File file[]=null;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewBalasEmail.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                viewBalasEmail dialog = new viewBalasEmail(new javax.swing.JFrame(), true);
